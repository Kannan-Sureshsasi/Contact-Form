<%@ Page Title="Home Page" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeBehind="Default.aspx.cs" Inherits="Contact_Form._Default" %>
...
<asp:Content ID="BodyContent" ContentPlaceHolderID="MainContent" runat="server">
    ...
    <asp:Table ID="ContactFormTable" runat="server" HorizontalAlign="Center" Height="478px" Width="534px" class="jumbotron" BackColor="#B59BFC" CssClass="auto-style1">
        ...
        <asp:TableRow>
                ...
                <asp:TableCell>
                    <asp:TextBox ID="txtSubject" runat="server" CssClass="wpforms-field-large" Required="true" BorderStyle="Solid" BorderColor="#000000" Placeholder="Enter your Subject Here" Rows="3" Columns="40"></asp:TextBox>
                </asp:TableCell>
            </asp:TableRow>
        <asp:TableRow>
            <asp:TableCell HorizontalAlign="Center">
        ...
        <asp:Label ID="confirm" runat="server" Text="" Font-Bold="true"></asp:Label>
</asp:Content>